...
class MainActivityTest {
    ...
    @Test fun checkManageTrip() {
        onView(withId(R.id.ManageTrip)).perform(com.example.FoodTripFrontend.click())
    ...
    @Test fun checkPastTrips() {
        onView(withId(R.id.PastTrips)).perform(com.example.FoodTripFrontend.click())
    ...
    @Test fun checkViewRecipe() {
        onView(withId(R.id.viewRecipes)).perform(com.example.FoodTripFrontend.click())
    ...
    @Test fun checkAccount() {
        onView(withId(R.id.ManageAccount)).perform(com.example.FoodTripFrontend.click())
    ...
    @Test fun signOut() {
        ...
        onView(withId(R.id.sign_out_button)).perform(com.example.FoodTripFrontend.click())
...
class MainActivityAdminTest {
    ...
    @Test fun setGroceriesButton() {
        onView(withId(R.id.GroceryButton)).perform(com.example.FoodTripFrontend.click())
...
//        val expectedCitiesList = mutableListOf<String>()
        ...
        onView(withId(R.id.CreateTrip)).perform(com.example.FoodTripFrontend.click())
...
class PastTripActivityTestPersonTest {
    ...
    @Test fun GeneralRecipeViewPastTrip() {
        ...
        onView(withTagValue(`is`("recipe 1"))).check(matches(isDisplayed())).perform(com.example.FoodTripFrontend.click())

        Thread.sleep(1000)
        Intents.intended(IntentMatchers.hasComponent(PopRecipeActivity::class.java.name))

        Thread.sleep(1000)
        onView(withTagValue(`is`("url"))).check(matches(isDisplayed())).perform(com.example.FoodTripFrontend.click())
...
class GroceryActivityTest {
     ...
     */
    @Test fun backButton() {
        onView(withId(R.id.back_button)).perform(com.example.FoodTripFrontend.click())
        Thread.sleep(5000)
        Intents.intended(IntentMatchers.hasComponent(MainActivity::class.java.name))
    }
...
class GroceryStoreActivityTest {
     ...
     */
    @Test fun checkElements() {
        onView(withId(R.id.sign_out_button)).check(matches(withText("Back")))
    ...
    @Test fun postAndDeleteDiscountTest() {
        ...
        onView(withId(R.id.delete_button_grocery_store)).perform(com.example.FoodTripFrontend.click())
        Thread.sleep(3000)
